        ...
        <div class="well">
          <div class="tab-content clearfix">
            <div class="tab-pane fade in active" id="tab1">
                ...
                <input id="#hidr" class="btn btn-default" value="Search" type="submit">   
            </div><!-- /tab-1-end -->
          </div><!-- /tab-content-end -->
        </div><!-- /well-end -->
     </div><!-- /dis-appear-end -->
               ...
               <h2>Flights</h2>
                <form class="m-bot-20"> 
                    <label class="radio-inline"> 
                        <input type="radio" value="option2" id="inlineRadio2" name="inlineRadioOptions" checked="checked"> 
                        One Way
                    </label> 
                    <label class="radio-inline"> 
